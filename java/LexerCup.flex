...
/* Comentarios */
( "//") {return new Symbol(sym.Comentarios, yychar, yyline, yytext());}

/* Multi_comentario_a */
( "/*") {return new Symbol(sym.Multi_comentario_a, yychar, yyline, yytext());}

/* Multi_comentario_c */
( "*/") {return new Symbol(sym.Multi_comentario_b, yychar, yyline, yytext());}
